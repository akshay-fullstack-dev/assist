...
class ProfileController extends Controller
{
    ...
    public function index() {
        ...
        if ($profile) {
            ...
            return redirect('admin/profile')->with('error_message', trans('admin/profile.invalid_profile_message'));
        }
    }
    ...
    public function update(Request $request) {
        ...
        if ($request->hasFile('image')) {
            if ($request->file('image')->isValid()) {
                ...
                $oldFile = \Config::get('constants.ADMIN_IMAGE_PATH').$admin->image;
                ...
                $filename = 'admin.'. $ext;
                $targetPath = \Config::get('constants.ADMIN_IMAGE_PATH');
